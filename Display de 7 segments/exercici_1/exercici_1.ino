...
long int t = 850;
long int a = 200;  // temps nomes per al punt del display.
...
void loop()
{
  ...
  delay(t);                  // es queden leds tms encesos
    ...
    //ESTE ES PARA INTERVALO ENTRE LAS DOS F
