...
unsigned long velocitat = 500;         //elocitat de l'acció en v ms
...
void loop()
{
  ...
  analogWrite(led5, 110);     // posar PWM del pin 11 a 60
  ...
  analogWrite(led4, 110);    // posar PWM del pin 10 a 125
  ...
  analogWrite(led3, 110);    // posar PWM del pin 9 a 255
  ...
  analogWrite(led2, 110);    // posar PWM del pin 6 a 125
  ...
  analogWrite(led1, 110);     // posar PWM del pin 5 a 60
  ...
  delay(velocitat);          // es queden leds velocitat ms en aquest estat
  analogWrite(led0, 130);     // posar PWM del pin 3 a 60
  analogWrite(led1, 20);     // posar PWM del pin 5 a 60
  analogWrite(led2, 0);     // posar PWM del pin 6 a 60
  analogWrite(led3, 0);     // posar PWM del pin 9 a 60
  analogWrite(led4, 0);     // posar PWM del pin 10 a 60
  analogWrite(led5, 0);     // posar PWM del pin 11 a 60
  ...
  delay(velocitat);          // es queden leds velocitat ms en aquest estat
analogWrite(led0, 20);     // posar PWM del pin 3 a 60
  analogWrite(led1, 0);     // posar PWM del pin 5 a 60
  analogWrite(led2, 0);     // posar PWM del pin 6 a 60
  analogWrite(led3, 0);     // posar PWM del pin 9 a 60
  analogWrite(led4, 0);     // posar PWM del pin 10 a 60
...
delay(velocitat);          // es queden leds velocitat ms en aquest estat
  ...
  delay(velocitat);          // es queden leds velocitat ms en aquest estatdelay(velocitat);          // es queden leds velocitat ms en aquest estat
  analogWrite(led0, 110);     // posar PWM del pin 3 a 60
  ...
  analogWrite(led0, 0);     // posar PWM del pin 3 a 60
  analogWrite(led1, 20);     // posar PWM del pin 5 a 60
  analogWrite(led2, 110);     // posar PWM del pin 6 a 60
  ...
  analogWrite(led1, 0);     // posar PWM del pin 5 a 60
  analogWrite(led2, 20);     // posar PWM del pin 6 a 60
  analogWrite(led3, 110);     // posar PWM del pin 9 a 60
  analogWrite(led4, 255);     // posar PWM del pin 10 a 60
  analogWrite(led5, 0);     // posar PWM del pin 11 a 60
  ...
  analogWrite(led1, 0);     // posar PWM del pin 5 a 60
  analogWrite(led2, 0);     // posar PWM del pin 6 a 60
  analogWrite(led3, 20);     // posar PWM del pin 9 a 60
  analogWrite(led4, 110);     // posar PWM del pin 10 a 60
  ...
  analogWrite(led2, 0);     // posar PWM del pin 6 a 60
  analogWrite(led3, 0);     // posar PWM del pin 9 a 60
  analogWrite(led4, 20);     // posar PWM del pin 10 a 60
  analogWrite(led5, 110);     // posar PWM del pin 11 a 60
  ...
  analogWrite(led3, 0);     // posar PWM del pin 9 a 60
  analogWrite(led4, 0);     // posar PWM del pin 10 a 60
  analogWrite(led5, 20);     // posar PWM del pin 11 a 60
